...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    services: [
      { label: t("footer.services.web"), href: "#portfolio" },
      { label: t("footer.services.ui"), href: "#portfolio" },
      { label: t("footer.services.mobile"), href: "#portfolio" },
      { label: t("footer.services.consulting"), href: "#contact" },
    ],
  };

  return (
    <footer
      className="relative border-t bg-[#0a0908]"
      style={{
        borderColor: "rgba(94, 80, 63, 0.5)",
    ...
    >
      <div
        ...
        style={{
          background: "linear-gradient(to top, #22333b, transparent)",
          opacity: 0.5,
          pointerEvents: "none",
        }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 space-y-16">
        <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="flex gap-3">
                {socialLinks.map((social) => (
                  <motion.a
                    ...
                    style={{
                      backgroundColor: "rgba(14,13,8,0.3)",
                      color: "#c6ac8f",
                    }}
                    onMouseEnter={(e) => {
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="font-bold text-lg mb-6 text-[#eae0d5]">
              {t("footer.navigation")}
            </h4>
          ...
          >
            ...
            <div className="mt-8">
              <p className="text-sm mb-2 text-[#eae0d5]">
                {t("footer.getInTouch")}:
              </p>
              <a
        ...
        <div
          ...
          style={{ borderColor: "rgba(94, 80, 63, 0.5)" }}
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <motion.div
              ...
              className="text-sm text-[#eae0d5]"
            >
              &copy; {currentYear} Gabriel Glatz. {t("footer.rights")}
            </motion.div>
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              transition={{ duration: 0.6, delay: 0.5 }}
              className="flex items-center gap-2 text-sm text-[#eae0d5]"
            >
